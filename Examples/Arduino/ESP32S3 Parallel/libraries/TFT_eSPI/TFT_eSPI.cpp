...
#if defined (SPI_HAS_TRANSACTION) && defined (SUPPORT_TRANSACTIONS) && !defined(TFT_PARALLEL_8_BIT) && !defined(TFT_PARALLEL_16_BIT) && !defined(RP2040_PIO_INTERFACE)
...
#else
  #if !defined(TFT_PARALLEL_8_BIT) && !defined(TFT_PARALLEL_16_BIT) && !defined(RP2040_PIO_INTERFACE)
...
void TFT_eSPI::init(uint8_t tc)
{
...
#if !defined (ESP32) && !defined(TFT_PARALLEL_8_BIT) && !defined(TFT_PARALLEL_16_BIT) && !defined(ARDUINO_ARCH_RP2040) && !defined (ARDUINO_ARCH_MBED)
  ...
  pinMode(TFT_CS, OUTPUT);
  digitalWrite(TFT_CS, HIGH); // Chip select high (inactive)
#elif defined (ESP8266) && !defined (TFT_PARALLEL_8_BIT) && !defined(TFT_PARALLEL_16_BIT) && !defined (RP2040_PIO_SPI)
...
// tft_settings.version is set in header file
  ...
  #if defined(TFT_PARALLEL_16_BIT)
	  tft_settings.pin_tft_d8 = TFT_D8;
	  tft_settings.pin_tft_d9 = TFT_D9;
	  tft_settings.pin_tft_d10 = TFT_D10;
	  tft_settings.pin_tft_d11 = TFT_D11;
	  tft_settings.pin_tft_d12 = TFT_D12;
	  tft_settings.pin_tft_d13 = TFT_D13;
	  tft_settings.pin_tft_d14 = TFT_D14;
	  tft_settings.pin_tft_d15 = TFT_D15;
  #else
	  tft_settings.pin_tft_d8 = -1;
	  tft_settings.pin_tft_d9 = -1;
	  tft_settings.pin_tft_d10 = -1;
	  tft_settings.pin_tft_d11 = -1;
	  tft_settings.pin_tft_d12 = -1;
	  tft_settings.pin_tft_d13 = -1;
	  tft_settings.pin_tft_d14 = -1;
	  tft_settings.pin_tft_d15 = -1;
  #endif
