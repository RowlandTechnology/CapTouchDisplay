...
// 8 BIT PARALLEL BUS
	...
	// 16 BIT PARALLEL BUS
		...
		#if CONFIG_TFT_D8 == -1
			#error "Invalid Data 8 pin. Check TFT_eSPI configuration"
		#else
			#define TFT_D8      CONFIG_TFT_D8
	    #endif

		#if CONFIG_TFT_D9 == -1
			#error "Invalid Data 9 pin. Check TFT_eSPI configuration"
		#else
			#define TFT_D9      CONFIG_TFT_D9
	    #endif

		#if CONFIG_TFT_D10 == -1
			#error "Invalid Data 10 pin. Check TFT_eSPI configuration"
		#else
			#define TFT_D10      CONFIG_TFT_D10
	    #endif

		#if CONFIG_TFT_D11 == -1
			#error "Invalid Data 11 pin. Check TFT_eSPI configuration"
		#else
			#define TFT_D11      CONFIG_TFT_D11
	    #endif

		#if CONFIG_TFT_D12 == -1
			#error "Invalid Data 12 pin. Check TFT_eSPI configuration"
		#else
			#define TFT_D12      CONFIG_TFT_D12
	    #endif

		#if CONFIG_TFT_D13 == -1
			#error "Invalid Data 13 pin. Check TFT_eSPI configuration"
		#else
			#define TFT_D13      CONFIG_TFT_D13
	    #endif

		#if CONFIG_TFT_D14 == -1
			#error "Invalid Data 14 pin. Check TFT_eSPI configuration"
		#else
			#define TFT_D14      CONFIG_TFT_D14
	    #endif

		#if CONFIG_TFT_D15 == -1
			#error "Invalid Data 15 pin. Check TFT_eSPI configuration"
		#else
			#define TFT_D15      CONFIG_TFT_D15
	    #endif
