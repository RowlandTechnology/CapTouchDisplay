...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  #define tft_Write_32(C) GPIO.out_w1tc = clr_mask; GPIO.out_w1ts = ((C) >> 16); WR_H; \
                          GPIO.out_w1tc = clr_mask; GPIO.out_w1ts = (C); WR_H

  // Write two concatenated 16 bit values to TFT
  #define tft_Write_32C(C,D) GPIO.out_w1tc = clr_mask; GPIO.out_w1ts = (C); WR_H; \
                             GPIO.out_w1tc = clr_mask; GPIO.out_w1ts = (D); WR_H

  // Write 16 bit value twice to TFT - used by drawPixel()
  #define tft_Write_32D(C) GPIO.out_w1tc = clr_mask; GPIO.out_w1ts = (C); WR_H; \
                           GPIO.out_w1tc = clr_mask; GPIO.out_w1ts = (C); WR_H
