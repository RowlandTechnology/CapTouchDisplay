...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  // Mask for the 8 data bits to set pin directions
  #define dir_mask ((1 << TFT_D0) | (1 << TFT_D1) | (1 << TFT_D2) | (1 << TFT_D3) | (1 << TFT_D4) | (1 << TFT_D5) | (1 << TFT_D6) | (1 << TFT_D7) | (1 << TFT_D8) | (1 << TFT_D9) | (1 << TFT_D10) | (1 << TFT_D11) | (1 << TFT_D12) | (1 << TFT_D13) | (1 << TFT_D14) | (1 << TFT_D15))
  ...
  #define tft_Write_8(C)  GPIO.out_w1tc = clr_mask; GPIO.out_w1ts = set_mask((uint8_t)(C)); WR_H
    ...
    #define tft_Write_16S(C) Cswap = ((C) >>8 | (C) << 8); tft_Write_16(Cswap)
      ...
      #define tft_Write_16(C)  GPIO.out_w1tc = clr_mask; GPIO.out_w1ts = (C) >> 0)); WR_H;
      #define tft_Write_16S(C) GPIO.out_w1tc = clr_mask; GPIO.out_w1ts = (C) >> 8)); WR_H;
    #else
      // Write 16 bits to TFT
      #define tft_Write_16(C) GPIO.out_w1tc = clr_mask; GPIO.out_w1ts = (C); WR_H;

      // 16 bit write with swapped bytes
      #define tft_Write_16S(C) GPIO.out_w1tc = clr_mask; GPIO.out_w1ts = (C); WR_H;
    #endif
